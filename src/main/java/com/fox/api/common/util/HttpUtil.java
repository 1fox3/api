...
public class HttpUtil {
    ...
    public String paramsToUrlParams() {
        if (!this.params.isEmpty()) {
            ...
            return org.apache.commons.lang.StringUtils.join(paramsList.toArray(), "&");
        }
        return "";
    }
     ...
     * @throws IOException
     */
    private HttpResponse readResponse(HttpURLConnection urlCon) throws IOException {
        try {
            ...
            return new HttpResponse(urlCon.getResponseCode(), urlCon.getHeaderFields(),
