...
@Service
@Primary
public class SinaRealtimeDealInfoSpiderApiImpl implements StockRealtimeDealInfoSpiderApiService {
    /**
     * 日志
     */
    ...
    private StockRealtimeDealInfoPo convertObj(SinaRealtimeDealInfoPo sinaRealtimeDealInfoPo) {
        if (sinaRealtimeDealInfoPo instanceof SinaRealtimeDealInfoPo) {
            ...
            BeanUtils.copyProperties(sinaRealtimeDealInfoPo, stockRealtimeDealInfoPo);
